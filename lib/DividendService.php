...
class DividendService
{
    ...
    public function __construct(?DividendDataProvider $provider = null, ?MarketDataService $market = null, ?CacheStore $cache = null, ?EventMarketWindowService $eventMarket = null)
    {
    ...
    public function eventMarketWindow(string $code, string $eventDate, int $before = 10, int $after = 15): DataSourceResult
    {
        ...
        return $this->eventMarket->window($market . $code, $code, $eventDate, $before, $after);
    }
