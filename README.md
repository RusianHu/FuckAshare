...
- 路由顺序为“站内搜索 → 个股 F10 公司资讯 → 7×24 快讯”：股票优先由独立 F10 JSON 接口精确补充，市场热点由快讯接管；三者使用独立熔断器且严格只输出四字段
- 基金若近期快讯没有关联记录会返回有效空结果，不把泛市场新闻或股票 F10 数据冒充基金新闻
...
| 新闻 PoC 数据源 | 东方财富公开新闻搜索（代码/名称/市场关键词映射；仅输出标题、来源、时间、链接） |
